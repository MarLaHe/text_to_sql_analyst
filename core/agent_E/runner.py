from core.agent_E.graph_builder import build_agent_graph
...
def run_batch_questions(questions: List[str], append_logs: bool = True, agent_id: str = "agent_E") -> List[Dict]:
    """
